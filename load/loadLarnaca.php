<?php
    $sqlVillages = "SELECT name FROM villageslarnaca;";
    ...
    if ($resultVillages->num_rows > 0) {
        ...
        while($rowV = $resultVillages->fetch_assoc()) {
            ...
            $sqlProperty = "SELECT * FROM propertylarnaca, villageslarnaca WHERE propertylarnaca.location='$vill' and villageslarnaca.Name='$vill' and propertylarnaca.exactLoc=0 ;";
    ...
    $sqlHouse = "SELECT * FROM propertylarnaca, propertylocation WHERE  propertylarnaca.exactLoc=1  and propertylarnaca.id =propertylocation.propertyID ;";
